...
/datum/supply_pack/organic/hydroponics/drugs
	name = "Drugs"
	desc = "Bee business booming? Drugs"
	cost = 1500
	contains = list(/obj/item/reagent_containers/syringe/contraband/methamphetamine,
...
/datum/supply_pack/organic/foodbbq
	name = "BBQ Cookout"
	desc = "BBQ COOKOUT"
	cost = 1500
	contains = list(/obj/item/reagent_containers/food/condiment/pack/bbqsauce,
					...
					/obj/item/reagent_containers/food/snacks/meat/slab/monkey,
					/obj/item/reagent_containers/food/snacks/meat/slab/monkey)
	crate_name = "BBQ cookout"

/datum/supply_pack/organic/cups
	name = "Cup Sampler"
	desc = "Cup Sampler"
	cost = 1000
	contains = list(/obj/item/reagent_containers/glass/maunamug,
			...
			/obj/item/reagent_containers/food/drinks/colocup/lean)
	crate_name = "Cup Sampler"

/datum/supply_pack/organic/drinksamples
	name = "Drink Sampler"
	desc = "Drink Sampler"
	cost = 1000
	contains = list(/obj/item/reagent_containers/food/drinks/bottle/sarsaparilla,
...
/datum/supply_pack/misc/revolvers
	name = "Revolver"
	desc = "Revolver"
	cost = 1000
	contains = list(/obj/item/gun/ballistic/revolver/mateba,
			...
			/obj/item/ammo_box/a357,
			/obj/item/ammo_box/a357)
	crate_name = "Collector Revolver"
	crate_type = /obj/structure/closet/crate/large

/datum/supply_pack/misc/swords
	name = "Collector Swords"
	desc = "Swords"
	cost = 5000
	contains = list(/obj/item/melee/greykingsword,
